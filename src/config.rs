...
// Ravine
pub const SPAWN_POINT: Position = Point3::new(219.0, 71.5, 208.4);
pub const SPAWN_DIR: Vector3<Coord> = Vector3::new(-0.71, -0.41, -0.57);
...
pub const FILTER_RIGID: bool = true;
